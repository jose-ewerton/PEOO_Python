...
dep = Departamento("Logística",1) #como pegar esse departamento e inserir na empresa!!? Resposta, posso fazer isso usando associação ou agregação;
...
emp.inserir_departamento("TI","001")  #criando e inserindo um departamento
dep2 = emp.acessar_departamentos("001") # pegando esse departamento e inserindo em uma variavel local
