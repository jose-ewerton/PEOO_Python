...
H = [] #Homens
M = [] #Mulheres
alh = []  #Altura dos homens
alm = [] #Altura das mulheres
pdh = []  #Peso dos homens
pdm = [] #Peso das mulheres
i = 0 
while i < 2:
   	...
   	if(genero == "H"):
   		...
   		alh.append(float(input("Qual a sua altura: ")))
   		pdh.append(float(input("Qual seu peso: ")))
   		...
   		i += 1
   			...
   			for item in M:
   				...
   				pdm.append(float(input("Qual seu peso: ")))
   				i +=1 
...
print("A mulher do grupo mais alta tem a altura de",max(alm),"M e o homem mais baixo do grupo tem",min(alh),"M")
